...
// Components
import SplashScreen from './pages/SVGNestReact/Splash/SplashScreen'
import ModeSwitcher from './pages/SVGNestReact/Components/Navigation/ModeSwitcher'
import Controls from './pages/SVGNestReact/Components/Navigation/Controls'
import Configuration from './pages/SVGNestReact/SingleBin/Configuration'
import ProgressSidebar from './pages/SVGNestReact/SingleBin/ProgressSidebar'
import SVGDisplay from './pages/SVGNestReact/SingleBin/SVGDisplay'
import MultiBinTester from './pages/SVGNestReact/MultiBin/MultiBinTester'
import { ShapeControls } from './pages/SVGNestReact/SingleBin/ShapeControls'
import CustomShapeBuilder from './pages/SVGNestReact/SingleBin/CustomShapeBuilder'
